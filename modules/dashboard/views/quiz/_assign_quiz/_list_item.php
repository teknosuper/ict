	          	...
	          	<div class="box box-primary box-solid">
		            <div class="box-header">
			              	...
			              	<table class="table table-condensed">
			                	<tbody>
				                  	...
				                  	<tr>
				                    	...
				                    	<td>:</td>
				                    	<td><?= $model->assignQuizModelBelongsToQuizModel->quizBelongsToMasterSubjectsModel->subjects;?></td>
				                  	</tr>
				                  	<tr>
				                    	<td>Semester</td>
				                    	<td>:</td>
			            ...
			            <div class="box-footer">
				        	<a href="/dashboard/quiz/updatepublishclassroom?id=<?=$model->id;?>" class="btn btn-block btn-default modal-form"><i class="fa fa-pencil"></i> Update Data</a>
			            </div>
	          	</div>
            </div>
	</div>