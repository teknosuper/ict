...
<div class="spe-title col-md-12">
	<h2>Materi <span><?= $searchModel->eLearningItemsModelBelongsToSubjectsPlanModel->chapter;?></span></h2>
	<div class="title-line">
		<div class="tl-1"></div>
		<div class="tl-2"></div>
		<div class="tl-3"></div>
	</div>
	<p>Pilih dan Pelajari Kumpulan Materi <?= $searchModel->eLearningItemsModelBelongsToSubjectsPlanModel->chapter;?></p>
</div>
